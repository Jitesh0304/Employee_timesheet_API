...
class TimesheetAdmin(admin.ModelAdmin):
    list_display = ['id','day', 'date','status', 'hours','organization','project_code','project_subcode', 'project_name',
                    'employee','bill','location','comment','submit','approve']
...
class WeeklyReportAdmin(admin.ModelAdmin):
    ...
    list_display = ['id','employee', 'week_start_date','week_end_date', 'submit','approve','submit_date','display_timesheet_list',
                    'approve_data','reject_data']
