...
from .views import CustomTokenObtainPairView, CustomTokenRefreshView, EmployeeRegistrationView, EmployeeLoginView, \
        ...
        EmployeePasswordResetView, EmployeeRegistrationByTeamLeaderView, DeleteEmployeeView
...
urlpatterns = [
    ...
    path('registerby/', EmployeeRegistrationByTeamLeaderView.as_view(), name='registerby'),
